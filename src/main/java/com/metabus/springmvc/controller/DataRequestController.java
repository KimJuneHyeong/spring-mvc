...
public class DataRequestController {
    ...
    public String helloRequestModelGet(@ModelAttribute Star star) {
        return String.format("Hello, @ModelAttribute로 받은 값들 Get요청, <br> name = %s, age = %d", star.getName(), star.getAge());
    }

    @PostMapping("/form/json")
    @ResponseBody
    public String helloRequestJson(@RequestBody Star star){
        return String.format("Hello, @RequestBody 받은 JSON -> 객체로 받기, <br> name =%s, age = %d", star.getName(), star.getAge());
    }
}
